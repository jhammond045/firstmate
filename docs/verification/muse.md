...
The Muse launch clears `CLAUDECODE`, `PI_CODING_AGENT`, `GROK_AGENT`, `FM_PI_HARNESS`, `CURSOR_AGENT`, `CURSOR_INVOKED_AS`, and `COPILOT_CLI` before the worker starts so foreign primary markers cannot override the versioned ancestry.
