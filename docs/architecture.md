...
That keeps spawn launch compatible across claude, codex, opencode, pi, pi-signed, grok, kimi, cursor, copilot, and muse while preserving the requested profile for later audit.
